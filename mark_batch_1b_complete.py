#!/usr/bin/env python3
"""
Mark exercises 21-40 (Batch 1b) in Origym.csv as COMPLETE
"""
...
def main():
    ...
    # Parse CSV and update status for exercises 21-40
    ...
    count = 0
    for row in reader:
        if row['Status'] == 'PENDING' and count < 20:  # Next 20 PENDING exercises
            row['Status'] = 'COMPLETE'
            count += 1
        rows.append(row)
    ...
    print(f"✓ Marked exercises 21-40 (Batch 1b) as COMPLETE")
